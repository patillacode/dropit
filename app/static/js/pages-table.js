import { fmtExpiry, fmtDate, fmtSize } from '/static/js/utils.js';
...
export function renderPagesTable(pages, { tableWrap, emptyEl, errorEl, showUploader = false, deletePage }) {
